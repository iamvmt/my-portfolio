  ...
  const projects = [
    {
      ...
      title: "Abhyudaya",
      description:
        "A modern cultural fest website of Madan Mohan Malaviya University of Technology built with React, Node.js, Express and MongoDB integration. Features include user authentication, event registration, and secure payment processing.",
    ...
    },
    {
      ...
      title: "Weather App",
      description:
        "A real-time weather application that provides accurate weather forecasts, interactive maps, and detailed analytics for multiple locations. Built with React.js, WeatherAPI, Tailwind, JavaScript.",
    ...
    // You can uncomment and fix these later if needed
    // {
    //   id: 3,
